...
//   x64
//   /tmp/hhvm-3.11.1/hphp/runtime/ext_hhvm/../../system/idl/CMakeFiles/hphp_runtime_ext.dir/collections.idl.json.ext_hhvm.h
//   /tmp/hhvm-3.11.1/hphp/runtime/ext_hhvm/../../system/idl/CMakeFiles/hphp_runtime_ext.dir/collections.idl.json.ext_hhvm.cpp
...
ObjectData* new_Pair_Instance(HPHP::Class* cls) {
  size_t nProps = cls->numDeclProperties();
  size_t builtinObjSize = sizeof(c_Pair) - sizeof(ObjectData);
  size_t size = ObjectData::sizeForNProps(nProps) + builtinObjSize;
  auto o = new (MM().objMalloc(size)) c_Pair(cls);
  assert(o->hasExactlyOneRef());
  return o;
}


void delete_Pair(ObjectData* obj, const Class* cls) {
  auto const ptr = static_cast<c_Pair*>(obj);
  ptr->~c_Pair();
  ...
  auto const builtinSz = sizeof(c_Pair) - sizeof(ObjectData);
  auto const size = ObjectData::sizeForNProps(nProps) + builtinSz;
  if (LIKELY(size <= kMaxSmallSize)) {
    return MM().freeSmallSize(ptr, size);
  }
...
IMPLEMENT_CLASS_NO_SWEEP(Pair);
TypedValue* tg_4Pair___construct(ActRec* ar) {
  void (*th_4Pair___construct)(c_Pair*,int64_t,Value*) =
    (void (*)(c_Pair*,int64_t,Value*))getMethodPtr(&HPHP::c_Pair::t___construct);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  c_Pair* this_ = (ar->hasThis() ? static_cast<c_Pair*>(ar->getThis()) :  nullptr);
  if (LIKELY(this_ != nullptr)) {
    rv->m_type = KindOfNull;
    ...
    th_4Pair___construct((this_), count, (Value*)(&extraArgs));
  } else {
...
TypedValue* tg_4Pair_isEmpty(ActRec* ar) {
  bool (*th_4Pair_isEmpty)(c_Pair*) =
    (bool (*)(c_Pair*))getMethodPtr(&HPHP::c_Pair::t_isempty);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      ...
      throw_toomany_arguments_nr("Pair::isEmpty", 0, count, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_count(ActRec* ar) {
  int64_t (*th_4Pair_count)(c_Pair*) =
    (int64_t (*)(c_Pair*))getMethodPtr(&HPHP::c_Pair::t_count);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      ...
      throw_toomany_arguments_nr("Pair::count", 0, count, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_items(ActRec* ar) {
  Value* (*th_4Pair_items)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_items);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      ...
      throw_toomany_arguments_nr("Pair::items", 0, count, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_keys(ActRec* ar) {
  Value* (*th_4Pair_keys)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_keys);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      ...
      throw_toomany_arguments_nr("Pair::keys", 0, count, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_values(ActRec* ar) {
  Value* (*th_4Pair_values)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_values);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_values(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::values", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::values");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_lazy(ActRec* ar) {
  Value* (*th_4Pair_lazy)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_lazy);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_lazy(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::lazy", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::lazy");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toArray(ActRec* ar) {
  Value* (*th_4Pair_toArray)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_toarray);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      ...
      throw_toomany_arguments_nr("Pair::toArray", 0, count, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_toVector(ActRec* ar) {
  Value* (*th_4Pair_toVector)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_tovector);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_toVector(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toVector", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toVector");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toImmVector(ActRec* ar) {
  Value* (*th_4Pair_toImmVector)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_toimmvector);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_toImmVector(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toImmVector", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toImmVector");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toMap(ActRec* ar) {
  Value* (*th_4Pair_toMap)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_tomap);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_toMap(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toMap", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toMap");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toImmMap(ActRec* ar) {
  Value* (*th_4Pair_toImmMap)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_toimmmap);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_toImmMap(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toImmMap", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toImmMap");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toSet(ActRec* ar) {
  Value* (*th_4Pair_toSet)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_toset);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_toSet(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toSet", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toSet");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toImmSet(ActRec* ar) {
  Value* (*th_4Pair_toImmSet)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_toimmset);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_toImmSet(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toImmSet", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toImmSet");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_immutable(ActRec* ar) {
  Value* (*th_4Pair_immutable)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_immutable);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfObject;
      th_4Pair_immutable(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::immutable", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::immutable");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toKeysArray(ActRec* ar) {
  Value* (*th_4Pair_toKeysArray)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_tokeysarray);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfArray;
      th_4Pair_toKeysArray(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toKeysArray", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toKeysArray");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_toValuesArray(ActRec* ar) {
  Value* (*th_4Pair_toValuesArray)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_tovaluesarray);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfArray;
      th_4Pair_toValuesArray(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::toValuesArray", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::toValuesArray");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_getIterator(ActRec* ar) {
  Value* (*th_4Pair_getIterator)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_getiterator);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      ...
      throw_toomany_arguments_nr("Pair::getIterator", 0, count, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_map(ActRec* ar) {
  Value* (*th_4Pair_map)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_map);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      ...
      throw_wrong_arguments_nr("Pair::map", count, 1, 1, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_mapWithKey(ActRec* ar) {
  Value* (*th_4Pair_mapWithKey)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_mapwithkey);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_mapWithKey(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::mapWithKey", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::mapWithKey");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_filter(ActRec* ar) {
  Value* (*th_4Pair_filter)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_filter);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      ...
      throw_wrong_arguments_nr("Pair::filter", count, 1, 1, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_filterWithKey(ActRec* ar) {
  Value* (*th_4Pair_filterWithKey)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_filterwithkey);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_filterWithKey(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::filterWithKey", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::filterWithKey");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_zip(ActRec* ar) {
  Value* (*th_4Pair_zip)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_zip);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      ...
      throw_wrong_arguments_nr("Pair::zip", count, 1, 1, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_take(ActRec* ar) {
  Value* (*th_4Pair_take)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_take);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_take(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::take", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::take");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_takeWhile(ActRec* ar) {
  Value* (*th_4Pair_takeWhile)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_takewhile);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_takeWhile(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::takeWhile", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::takeWhile");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_skip(ActRec* ar) {
  Value* (*th_4Pair_skip)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_skip);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_skip(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::skip", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::skip");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_skipWhile(ActRec* ar) {
  Value* (*th_4Pair_skipWhile)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_skipwhile);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_skipWhile(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::skipWhile", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::skipWhile");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_linearSearch(ActRec* ar) {
  int64_t (*th_4Pair_linearSearch)(c_Pair*,TypedValue*) =
    (int64_t (*)(c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_linearsearch);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfInt64;
      rv->m_data.num = (int64_t)th_4Pair_linearSearch((this_), (args-0));
    } else {
      throw_wrong_arguments_nr("Pair::linearSearch", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::linearSearch");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_slice(ActRec* ar) {
  Value* (*th_4Pair_slice)(Value*,c_Pair*,TypedValue*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_slice);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 2)) {
      rv->m_type = KindOfObject;
      th_4Pair_slice(&(rv->m_data), (this_), (args-0), (args-1));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::slice", count, 2, 2, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::slice");
  }
  frame_free_locals_inl(ar, 2, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_concat(ActRec* ar) {
  Value* (*th_4Pair_concat)(Value*,c_Pair*,TypedValue*) =
    (Value* (*)(Value*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_concat);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfObject;
      th_4Pair_concat(&(rv->m_data), (this_), (args-0));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::concat", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::concat");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_firstValue(ActRec* ar) {
  TypedValue* (*th_4Pair_firstValue)(TypedValue*,c_Pair*) =
    (TypedValue* (*)(TypedValue*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_firstvalue);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      th_4Pair_firstValue(rv, (this_));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::firstValue", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::firstValue");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_firstKey(ActRec* ar) {
  TypedValue* (*th_4Pair_firstKey)(TypedValue*,c_Pair*) =
    (TypedValue* (*)(TypedValue*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_firstkey);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      th_4Pair_firstKey(rv, (this_));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::firstKey", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::firstKey");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_lastValue(ActRec* ar) {
  TypedValue* (*th_4Pair_lastValue)(TypedValue*,c_Pair*) =
    (TypedValue* (*)(TypedValue*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_lastvalue);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      th_4Pair_lastValue(rv, (this_));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::lastValue", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::lastValue");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_lastKey(ActRec* ar) {
  TypedValue* (*th_4Pair_lastKey)(TypedValue*,c_Pair*) =
    (TypedValue* (*)(TypedValue*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t_lastkey);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      th_4Pair_lastKey(rv, (this_));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::lastKey", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::lastKey");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair_at(ActRec* ar) {
  TypedValue* (*th_4Pair_at)(TypedValue*,c_Pair*,TypedValue*) =
    (TypedValue* (*)(TypedValue*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_at);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      ...
      throw_wrong_arguments_nr("Pair::at", count, 1, 1, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_get(ActRec* ar) {
  TypedValue* (*th_4Pair_get)(TypedValue*,c_Pair*,TypedValue*) =
    (TypedValue* (*)(TypedValue*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_get);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      ...
      throw_wrong_arguments_nr("Pair::get", count, 1, 1, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair_containsKey(ActRec* ar) {
  bool (*th_4Pair_containsKey)(c_Pair*,TypedValue*) =
    (bool (*)(c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t_containskey);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      ...
      throw_wrong_arguments_nr("Pair::containsKey", count, 1, 1, 1, rv);
    }
  } else {
...
TypedValue* tg_4Pair___toString(ActRec* ar) {
  Value* (*th_4Pair___toString)(Value*,c_Pair*) =
    (Value* (*)(Value*,c_Pair*))getMethodPtr(&HPHP::c_Pair::t___tostring);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 0)) {
      rv->m_type = KindOfString;
      th_4Pair___toString(&(rv->m_data), (this_));
      if (UNLIKELY(rv->m_data.num == 0LL)) rv->m_type = KindOfNull;
      frame_free_inl(ar, rv);
      ar->m_r = *rv;
      return &ar->m_r;
    } else {
      throw_toomany_arguments_nr("Pair::__toString", 0, count, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::__toString");
  }
  frame_free_locals_inl(ar, 0, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair___get(ActRec* ar) {
  TypedValue* (*th_4Pair___get)(TypedValue*,c_Pair*,TypedValue*) =
    (TypedValue* (*)(TypedValue*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t___get);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      th_4Pair___get(rv, (this_), (args-0));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::__get", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::__get");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair___set(ActRec* ar) {
  TypedValue* (*th_4Pair___set)(TypedValue*,c_Pair*,TypedValue*,TypedValue*) =
    (TypedValue* (*)(TypedValue*,c_Pair*,TypedValue*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t___set);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 2)) {
      th_4Pair___set(rv, (this_), (args-0), (args-1));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::__set", count, 2, 2, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::__set");
  }
  frame_free_locals_inl(ar, 2, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair___isset(ActRec* ar) {
  bool (*th_4Pair___isset)(c_Pair*,TypedValue*) =
    (bool (*)(c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t___isset);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      rv->m_type = KindOfBoolean;
      rv->m_data.num = (th_4Pair___isset((this_), (args-0))) ? 1LL : 0LL;
    } else {
      throw_wrong_arguments_nr("Pair::__isset", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::__isset");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
...
TypedValue* tg_4Pair___unset(ActRec* ar) {
  TypedValue* (*th_4Pair___unset)(TypedValue*,c_Pair*,TypedValue*) =
    (TypedValue* (*)(TypedValue*,c_Pair*,TypedValue*))getMethodPtr(&HPHP::c_Pair::t___unset);
  TypedValue rvSpace;
  TypedValue* rv = &rvSpace;
  int32_t count = ar->numArgs();
  TypedValue* args UNUSED = ((TypedValue*)ar) - 1;
  ...
  if (LIKELY(this_ != nullptr)) {
    if (LIKELY(count == 1)) {
      th_4Pair___unset(rv, (this_), (args-0));
      if (UNLIKELY(rv->m_type == KindOfUninit)) rv->m_type = KindOfNull;
    } else {
      throw_wrong_arguments_nr("Pair::__unset", count, 1, 1, 1, rv);
    }
  } else {
    throw_instance_method_fatal("Pair::__unset");
  }
  frame_free_locals_inl(ar, 1, rv);
  ar->m_r = *rv;
  return &ar->m_r;
