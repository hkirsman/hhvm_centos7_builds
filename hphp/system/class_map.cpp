...
const char *g_class_map[] = {
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.containsKey.php )\n * Returns true if the specified key is present in the Vector, returns false otherwise.\n *\n * @key mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.append.php )\n *\n * @val mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.pop.php )\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "resize", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.resize.php )\n *\n * @sz mixed \n * @value mixed \n *\n */",
  (const char *)0x1,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.filterWithKey.php )\n * Returns a Vector of all the values from this Vector for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.linearSearch.php )\n * Returns index of the specified value if it is present, -1 otherwise.\n *\n * @search_value mixed \n *\n * @return int64_t \n */",
  (const char *)0x11,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.shuffle.php )\n * Shuffles the values of the Vector randomly in place.\n *\n */",
  (const char *)0x1,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.fromItems.php )\n * Returns a Vector built from the values produced by the specified Iterable.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Vector.fromKeysOf.php )\n * Returns a Vector built from the keys of the specified container.\n *\n * @container mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "container", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002240, "fromKeysOf", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.fromKeysOf.php )\n * Returns a ImmVector built from the keys of the specified container.\n *\n * @container mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "container", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "isEmpty", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.isEmpty.php )\n * Returns true if the ImmVector is empty, false otherwise.\n *\n * @return bool \n */",
  (const char *)0x9,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "count", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.count.php )\n * Returns the number of values in the ImmVector.\n *\n * @return int64_t \n */",
  (const char *)0x11,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "items", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.items.php )\n * Returns an Iterable that produces the values from this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "containsKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.containsKey.php )\n * Returns true if the specified key is present in the ImmVector, returns false otherwise.\n *\n * @key mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "at", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.at.php )\n * Returns the value at the specified key. If the key is not present, an exception is thrown.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.get.php )\n * Returns the value at the specified key. If the key is not present, null is returned.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "filterWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.filterWithKey.php )\n * Returns a Vector of all the values from this ImmVector for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "zip", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.zip.php )\n * Returns a KeyedIterable produced by combined the specified Iterables pair-wise.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "firstValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.firstValue.php )\n * Returns the first value from this ImmVector, or null if this ImmVector is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "firstKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.firstKey.php )\n * Returns the first key from this ImmVector, or null if this ImmVector is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.lastValue.php )\n * Returns the last value from this ImmVector, or null if this ImmVector is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.lastKey.php )\n * Returns the last key from this ImmVector, or null if this ImmVector is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "keys", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.keys.php )\n * Returns an Iterable that produces the keys from this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__set", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.--set.php )\n *\n * @name  \n * @value  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "value", "", (const char *)0xffffffff,
  ...
  NULL,
  (const char *)0x10002040, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "toVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toVector.php )\n * Returns a Vector built from the values of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toImmVector.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toMap.php )\n * Returns a Map built from the keys and values of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toImmMap.php )\n * Returns a ImmMap built from the keys and values of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toSet.php )\n * Returns a Set built from the values of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toImmSet.php )\n * Returns a ImmSet built from the values of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "immutable", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.immutable.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "values", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.values.php )\n * Returns a clone of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lazy", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.lazy.php )\n * Returns a lazy iterable view of this ImmVector.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toArray.php )\n * Returns an array built from the values from this ImmVector.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toKeysArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toKeysArray.php )\n * Returns an array built from the keys from this ImmVector.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toValuesArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.toValuesArray.php )\n * Returns an array built from the values from this ImmVector.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "linearSearch", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmVector.linearSearch.php )\n * Returns index of the specified value if it is present, -1 otherwise.\n *\n * @search_value mixed \n *\n * @return int64_t \n */",
  (const char *)0x11,
  (const char *)0x2000, "search_value", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "isEmpty", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.isEmpty.php )\n * Returns true if the Map is empty, false otherwise.\n *\n * @return bool \n */",
  (const char *)0x9,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "count", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.count.php )\n * Returns the number of key/value pairs in the Map.\n *\n * @return int64_t \n */",
  (const char *)0x11,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "items", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.items.php )\n * Returns an Iterable that produces the key/value Pairs from this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "keys", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.keys.php )\n * Returns a Vector built from the keys of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lazy", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.lazy.php )\n * Returns a lazy iterable view of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "at", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.at.php )\n * Returns the value at the specified key. If the key is not present, an exception is thrown.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.get.php )\n * Returns the value at the specified key. If the key is not present, null is returned.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "clear", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.clear.php )\n * Removes all key/value pairs from the Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "contains", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.contains.php )\n * Returns true if the specified key is present in the Map, false otherwise.\n *\n * @key mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "containsKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.containsKey.php )\n * Returns true if the specified key is present in the Map, false otherwise.\n *\n * @key mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.remove.php )\n * Removes the specified key from this Map.\n *\n * @key mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "removeKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.removeKey.php )\n * Removes the specified key from this Map.\n *\n * @key mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "toArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toArray.php )\n * Returns an array built from the keys and values from this Map.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toVector.php )\n * Returns a Vector built from the values of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toImmVector.php )\n * Returns a ImmVector built from the values of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toMap.php )\n * Returns a copy of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toImmMap.php )\n * Returns a ImmMap built from the keys and values of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toSet.php )\n * Returns a Set built from the values of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toImmSet.php )\n * Returns a ImmSet built from the values of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "immutable", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.immutable.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "values", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.values.php )\n * Returns a Vector built from the values of this Map.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toKeysArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toKeysArray.php )\n * Returns an array built from the keys from this Map.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toValuesArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.toValuesArray.php )\n * Returns an array built from the values from this Map.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "differenceByKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.differenceByKey.php )\n *\n * @it mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  ...
  NULL,
  (const char *)0x10002040, "filterWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.filterWithKey.php )\n * Returns a new Map of all the keys/values from this Map for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "zip", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.zip.php )\n * Returns a KeyedIterable produced by combined the specified Iterables pair-wise.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "firstValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.firstValue.php )\n * Returns the first value from this Map, or null if this Map is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "firstKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.firstKey.php )\n * Returns the first key from this Map, or null if this Map is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.lastValue.php )\n * Returns the last value from this Map, or null if this Map is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.lastKey.php )\n * Returns the last key from this Map, or null if this Map is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Map.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "isEmpty", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.isEmpty.php )\n * Returns true if the ImmMap is empty, false otherwise.\n *\n * @return bool \n */",
  (const char *)0x9,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "count", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.count.php )\n * Returns the number of key/value pairs in the ImmMap.\n *\n * @return int64_t \n */",
  (const char *)0x11,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "items", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.items.php )\n * Returns an Iterable that produces the key/value Pairs from this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "keys", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.keys.php )\n * Returns a ImmVector built from the keys of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lazy", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.lazy.php )\n * Returns a lazy iterable view of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "at", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.at.php )\n * Returns the value at the specified key. If the key is not present, an exception is thrown.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.get.php )\n * Returns the value at the specified key. If the key is not present, null is returned.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "containsKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.containsKey.php )\n * Returns true if the specified key is present in the ImmMap, false otherwise.\n *\n * @key mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "toArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toArray.php )\n * Returns an array built from the keys and values from this ImmMap.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toVector.php )\n * Returns a Vector built from the values of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toImmVector.php )\n * Returns a ImmVector built from the values of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toMap.php )\n * Returns a Map built from the keys and values of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toImmMap.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toSet.php )\n * Returns a Set built from the values of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toImmSet.php )\n * Returns a ImmSet built from the values of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "immutable", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.immutable.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "values", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.values.php )\n * Returns a ImmVector built from the values of this ImmMap.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toKeysArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toKeysArray.php )\n * Returns an array built from the keys from this ImmMap.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toValuesArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.toValuesArray.php )\n * Returns an array built from the values from this ImmMap.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "differenceByKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.differenceByKey.php )\n *\n * @it mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "it", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "filterWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.filterWithKey.php )\n * Returns a ImmMap of all the keys/values from this ImmMap for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "zip", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.zip.php )\n * Returns a KeyedIterable produced by combined the specified Iterables pair-wise.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "firstValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.firstValue.php )\n * Returns the first value from this ImmMap, or null if this ImmMap is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "firstKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.firstKey.php )\n * Returns the first key from this ImmMap, or null if this ImmMap is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.lastValue.php )\n * Returns the last value from this ImmMap, or null if this ImmMap is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.lastKey.php )\n * Returns the last key from this ImmMap, or null if this ImmMap is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__set", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.--set.php )\n *\n * @name  \n * @value  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "value", "", (const char *)0xffffffff,
  ...
  NULL,
  (const char *)0x10002040, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmMap.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/function.HH\\Set.php )\n * An ordered set-style collection.\n *\n */",
  "mutableset", NULL,
  (const char *)0x10002040, "__construct", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.--construct.php )\n * Returns a Set built from the values produced by the specified Iterable.\n *\n * @iterable mixed \n *\n */",
  (const char *)0x1,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "N;", (const char*)2, "null", (const char*)4, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "isEmpty", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.isEmpty.php )\n * Returns true if the Set is empty, false otherwise.\n *\n * @return bool \n */",
  (const char *)0x9,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "count", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.count.php )\n * Returns the number of values in the Set.\n *\n * @return int64_t \n */",
  (const char *)0x11,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "items", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.items.php )\n * Returns an Iterable that produces the values from this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "keys", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.keys.php )\n * Returns a Vector built from the keys of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "values", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.values.php )\n * Returns a Vector built from the values of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lazy", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.lazy.php )\n * Returns a lazy iterable view of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "clear", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.clear.php )\n * Removes all values from the Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "contains", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.contains.php )\n * Returns true if the specified value is present in the Set, returns false otherwise.\n *\n * @val mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "val", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "remove", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.remove.php )\n * Removes the specified value from this Set.\n *\n * @val mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "val", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "add", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.add.php )\n * Adds the specified value to this Set.\n *\n * @val mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "val", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "addAllKeysOf", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.addAllKeysOf.php )\n * Adds the keys of the specified KeyedContainer to this Set.\n *\n * @container mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "container", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "toArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toArray.php )\n * Returns an array built from the values from this Set, array(val1 => val1, val2 => val2, ...). This maintains set-like semantics in array() land: O(1) membership test with `array_has_key($a['key'])` and iteration with `foreach($a as $member)`. Int-like strings end up with numerical array keys.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toVector.php )\n * Returns a Vector built from the values of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toImmVector.php )\n * Returns a ImmVector built from the values of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toMap.php )\n * Returns a Map built from the keys and values of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toImmMap.php )\n * Returns a ImmMap built from the keys and values of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toSet.php )\n * Returns a copy of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toImmSet.php )\n * Returns a ImmSet built from the values of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "immutable", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.immutable.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toKeysArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toKeysArray.php )\n * Returns an array built from the values from this Set.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toValuesArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.toValuesArray.php )\n * Returns an array built from the values from this Set.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "getIterator", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.getIterator.php )\n * Returns an iterator that points to beginning of this Set.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "map", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.map.php )\n * Returns a Set of the values produced by applying the specified callback on each value from this Set.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "filterWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.filterWithKey.php )\n * Returns a Set of all the values from this Set for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.difference.php )\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.--get.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__set", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.--set.php )\n *\n * @name  \n * @value  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "value", "", (const char *)0xffffffff,
  ...
  NULL,
  (const char *)0x10002040, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002240, "fromItems", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.fromItems.php )\n * Returns a Set built from the values produced by the specified Iterable.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002240, "fromKeysOf", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Set.fromKeysOf.php )\n * Returns a Set built from the keys of the specified container.\n *\n * @container mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "container", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/function.HH\\ImmSet.php )\n * An immutable ordered set-style collection.\n *\n */",
  "constset", NULL,
  (const char *)0x10002040, "__construct", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.--construct.php )\n * Returns a ImmSet built from the values produced by the specified Iterable.\n *\n * @iterable mixed \n *\n */",
  (const char *)0x1,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "N;", (const char*)2, "null", (const char*)4, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "isEmpty", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.isEmpty.php )\n * Returns true if the ImmSet is empty, false otherwise.\n *\n * @return bool \n */",
  (const char *)0x9,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "count", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.count.php )\n * Returns the number of values in the ImmSet.\n *\n * @return int64_t \n */",
  (const char *)0x11,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "items", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.items.php )\n * Returns an Iterable that produces the values from this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "keys", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.keys.php )\n * Returns a Vector built from the keys of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "values", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.values.php )\n * Returns a ImmVector built from the values of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lazy", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.lazy.php )\n * Returns a lazy iterable view of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "contains", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.contains.php )\n * Returns true if the specified value is present in the ImmSet, returns false otherwise.\n *\n * @val mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "val", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "toArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toArray.php )\n * Returns an array built from the values from this ImmSet, array(val1 => val1, val2 => val2, ...). This maintains set-like semantics in array() land: O(1) membership test with `array_has_key($a['key'])` and iteration with `foreach($a as $member)`. Int-like strings end up with numerical array keys.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toVector.php )\n * Returns a Vector built from the values of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toImmVector.php )\n * Returns a ImmVector built from the values of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toMap.php )\n * Returns a Map built from the keys and values of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toImmMap.php )\n * Returns a ImmMap built from the keys and values of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toSet.php )\n * Returns a Set built from the values of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toImmSet.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "immutable", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.immutable.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toKeysArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toKeysArray.php )\n * Returns an array built from the values from this ImmSet.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toValuesArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.toValuesArray.php )\n * Returns an array built from the values from this ImmSet.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "getIterator", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.getIterator.php )\n * Returns an iterator that points to beginning of this ImmSet.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "map", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.map.php )\n * Returns a ImmSet of the values produced by applying the specified callback on each value from this ImmSet.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "filterWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.filterWithKey.php )\n * Returns a ImmSet of all the values from this ImmSet for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "firstValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.firstValue.php )\n * Returns the first value from this ImmSet, or null if this ImmSet is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "firstKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.firstKey.php )\n * Returns the first key from this ImmSet, or null if this ImmSet is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.lastValue.php )\n * Returns the last value from this ImmSet, or null if this ImmSet is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.lastKey.php )\n * Returns the last key from this ImmSet, or null if this ImmSet is empty.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "__get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.--get.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__set", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.--set.php )\n *\n * @name  \n * @value  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "value", "", (const char *)0xffffffff,
  ...
  NULL,
  (const char *)0x10002040, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002240, "fromItems", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.fromItems.php )\n * Returns a ImmSet built from the values produced by the specified Iterable.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002240, "fromKeysOf", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/ImmSet.fromKeysOf.php )\n * Returns a ImmSet built from the keys of the specified container.\n *\n * @container mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "container", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  NULL,
  (const char *)0x1800a020, "HH\\Pair", "", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/function.HH\\Pair.php )\n * An immutable ordered fixed-sized container.\n *\n */",
  "constvector", NULL,
  (const char *)0x10022040, "__construct", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.--construct.php )\n *\n */",
  (const char *)0x1,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "isEmpty", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.isEmpty.php )\n * Returns true if this Pair is empty, false otherwise.\n *\n * @return bool \n */",
  (const char *)0x9,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "count", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.count.php )\n * Returns the number of values in the Pair.\n *\n * @return int64_t \n */",
  (const char *)0x11,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "items", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.items.php )\n * Returns an Iterable that produces the values from this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "keys", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.keys.php )\n * Returns a Vector built from the keys of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "values", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.values.php )\n * Returns a Vector built from the values of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lazy", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.lazy.php )\n * Returns a lazy iterable view of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toArray.php )\n * Returns an array built from the values from this Pair.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toVector.php )\n * Returns a Vector build from the values from this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmVector", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toImmVector.php )\n * Returns a ImmVector built from the values of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toMap.php )\n * Returns a Map built from the keys and values of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmMap", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toImmMap.php )\n * Returns a ImmMap built from the keys and values of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toSet.php )\n * Returns a Set built from the values of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toImmSet", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toImmSet.php )\n * Returns a ImmSet built from the values of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "immutable", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.immutable.php )\n * Returns an immutable version of this collection.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toKeysArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toKeysArray.php )\n * Returns an array built from the keys from this Pair.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "toValuesArray", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.toValuesArray.php )\n * Returns an array built from the values from this Pair.\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "getIterator", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.getIterator.php )\n * Returns an iterator that points to beginning of this Pair.\n *\n * @return Object \n */",
  (const char *)0x40,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "map", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.map.php )\n * Returns a Vector of the values produced by applying the specified callback on each value from this Pair.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "mapWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.mapWithKey.php )\n * Returns a Vector of the values produced by applying the specified callback on each key and value from this Pair.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "filter", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.filter.php )\n * Returns a Vector of all the values from this Pair for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "filterWithKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.filterWithKey.php )\n * Returns a Vector of all the values from this Pair for which the specified callback returns true.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "zip", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.zip.php )\n * Returns a KeyedIterable produced by combined the specified Iterables pair-wise.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "takeWhile", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.takeWhile.php )\n * Returns a Vector containing the values of this Pair up to but not including the first value that produces false when passed to the specified callback.\n *\n * @callback mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "callback", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "skipWhile", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.skipWhile.php )\n * Returns a Vector containing all the values of this Pair excluding the first values that produces true when passed to the specified callback.\n *\n * @fn mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "fn", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "linearSearch", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.linearSearch.php )\n * Returns index of the specified value if it is present, -1 otherwise.\n *\n * @search_value mixed \n *\n * @return int64_t \n */",
  (const char *)0x11,
  (const char *)0x2000, "search_value", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "slice", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.slice.php )\n * Returns an ImmVector containing the specified range of values from this Pair. The range is specified by two non-negative integers: a starting position and a length.\n *\n * @start mixed \n * @len mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "start", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "len", "", (const char *)0xffffffff,
  ...
  NULL,
  (const char *)0x10002040, "concat", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.concat.php )\n * Builds a new ImmVector by concatenating the elements of this Pair with the elements of the specified Iterable.\n *\n * @iterable mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "iterable", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "firstValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.firstValue.php )\n * Returns the first value from this Pair.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "firstKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.firstKey.php )\n * Returns the first key from this Pair.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastValue", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.lastValue.php )\n * Returns the last value from this Pair.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "lastKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.lastKey.php )\n * Returns the last key from this Pair.\n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002040, "at", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.at.php )\n * Returns the value at the specified key. If the key is not present, an exception is thrown.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.get.php )\n * Returns the value at the specified key. If the key is not present, null is returned.\n *\n * @key mixed \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "containsKey", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.containsKey.php )\n * Returns true if the specified key is present in the Pair, returns false otherwise.\n *\n * @key mixed \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "key", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__toString", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.--toString.php )\n *\n * @return String \n */",
  (const char *)0x22,
  NULL,
  NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__set", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.--set.php )\n *\n * @name  \n * @value  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "value", "", (const char *)0xffffffff,
  ...
  NULL,
  (const char *)0x10002040, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  (const char *)0x10002040, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Pair.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  ...
  NULL,
  NULL,
  (const char *)0x18002000, "Closure", "", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/function.Closure.php )\n * Used as the base class for all closures\n *\n */",
  NULL,
  (const char *)0x10002060, "__construct", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.--construct.php )\n *\n */",
  (const char *)0x1,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002060, "__debuginfo", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.--debuginfo.php )\n *\n * @return Array \n */",
  (const char *)0x34,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002060, "__get", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.--get.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002060, "__set", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.--set.php )\n *\n * @name  \n * @value  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "value", "", (const char *)0xffffffff,
  ...
  NULL,
  NULL,
  (const char *)0x10002060, "__isset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.--isset.php )\n *\n * @name  \n *\n * @return bool \n */",
  (const char *)0x9,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002060, "__unset", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.--unset.php )\n *\n * @name  \n *\n * @return mixed \n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "name", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002260, "bind", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.bind.php )\n *\n * @closure mixed \n * @newthis mixed \n * @newscope mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "closure", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "newthis", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "newscope", "", (const char *)0xffffffff,
    "s:6:\"static\";", (const char*)13, "\"static\"", (const char*)8, NULL,
  NULL,
  NULL,
  NULL,
  (const char *)0x10002060, "bindto", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.bindto.php )\n *\n * @newthis mixed \n * @newscope mixed \n *\n * @return Object \n */",
  (const char *)0x40,
  (const char *)0x2000, "newthis", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  (const char *)0x2000, "newscope", "", (const char *)0xffffffff,
  ...
  NULL,
  NULL,
  (const char *)0x10022060, "call", "", (const char*)0, (const char*)0,
  "/**\n * ( excerpt from http://docs.hhvm.com/manual/en/Closure.call.php )\n * Binds and calls the closure. Temporarily binds the closure to newthis, and calls it with any given parameters.\n *\n * @newthis mixed The object to bind the closure to for the duration of the call.\n *\n * @return mixed Returns the return value of the closure.\n */",
  (const char *)0xffffffff,
  (const char *)0x2000, "newthis", "", (const char *)0xffffffff,
    "", (const char*)0, "", (const char*)0, NULL,
  NULL,
